import { Divider, Drawer as MuiDrawer, IconButton, List, styled, Theme, CSSObject } from "@mui/material";
...
const NavDrawer = ({open, handleDrawerClose, theme, primaryNavOptions, secondaryNavOptions }: NavDrawerProps) => (
            ...
            {primaryNavOptions.map((option) => (
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Link to={option.path}>{option.icon}</Link>
                        </ListItemIcon>
                        <ListItemText
                            primary={option.text}
                            sx={{ opacity: open ? 1 : 0 }} />
